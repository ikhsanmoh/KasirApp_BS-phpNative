<?php
  ...
  if ( isset($_GET['id']) ) {
    ...
    $query = "DELETE FROM tb_categories WHERE id_kat LIKE '$id'";
    ...
    if ($sql) {
      ...
      header('location: '. $base . 'app/pages/products/category.php?status=sukses_delete');
    
    } else {

      // Redirect dengan status gagal
      header('location: '. $base . 'app/pages/products/category.php?status=gagal_delete');
